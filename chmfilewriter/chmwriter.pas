...
Type
  ...
  public
    ...
    property LocaleID: dword read FLocaleID write FLocaleID default $0409;
  end;
...
begin
  with ITSFHeader do begin
    ...
    LanguageID := NToLE(DWord(LocaleID)); //0419 // 0409 = English / English_US
  end;
end;
...
begin
  ...
  with HeaderSection1 do begin // TITSPHeader; // DirectoryListings header
    ...
    LanguageID := NToLE(DWord(LocaleID)); // 0419 0409 - english
    GUID := ITSPHeaderGUID;
...
begin
 ...
 { if FileExists('#SYSTEM') then
  ...
  FSection0.WriteDWord(NToLE(DWord(LocaleID))); //0419 0409
